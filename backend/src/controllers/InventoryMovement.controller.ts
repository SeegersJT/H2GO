...
export class InventoryMovementController {
  static getAll = async (_req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      return res.succeed(result, { message: "Retrieved inventorymovements successfully." });
    } catch (err) {
      next(err);
    }
  };
  ...
  static getById = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      return res.succeed(result, { message: "Retrieved inventorymovement successfully." });
    } catch (err) {
      next(err);
    }
  };
  ...
  static create = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      return res.succeed(result, { message: "Created inventorymovement successfully." });
    } catch (err) {
      next(err);
    }
  };
  ...
  static update = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      return res.succeed(result, { message: "Updated inventorymovement successfully." });
    } catch (err) {
      next(err);
    }
  };
  ...
  static delete = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      return res.succeed(result, { message: "Deleted inventorymovement successfully." });
    } catch (err) {
      next(err);
    }
  };
