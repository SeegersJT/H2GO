      ...
      <div className="space-y-4 py-4">
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  cn(
                    ...
                    isActive
                      ? 'bg-waterboy-50 text-waterboy-900 font-medium'
                ...
                {({ isActive }) => (
                  <>
                    <nav.icon
                      className={cn(
                        'h-4 w-4',
                        isActive ? 'text-waterboy-600' : 'text-muted-foreground',
                      )}
                    />
                    <span>{nav.title}</span>
                  </>
        ...
        <div className="px-3 py-2">
          <div className="m-2 rounded-md bg-waterboy-50 p-4">
            ...
            <p className="text-xs text-waterboy-700">
              Contact our support team for assistance with your water delivery needs.
            </p>
            <Button
              variant="default"
              size="sm"
              className="mt-3 w-full bg-waterboy-600 hover:bg-waterboy-700"
            >
              Contact Support
            </Button>
          </div>
